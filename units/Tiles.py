...
reed_img = _item_img(_REED, "#CA8A04", scale=4)
...
firebloom_img = _item_img(_FIREBLOOM, "#EA580C", scale=4)
...
moonbloom_img = _item_img(_MOONBLOOM, "#C7D2FE", scale=4)
...
STANDING_TILES = {0, 110, 120, 121, 122, 123, 125, 126, 130, 129, 131} | ON_EARTHEN_PLANTS | CAVE_PLANTS
# Задние панельки
BACKTILES = {1003, }
