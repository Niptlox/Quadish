...
achievements = {
    ...
    # достижения обучения
    "tutorial_wood": {"title": "Лесоруб", "description": "Вы добыли первую древесину",
                      "action": "Добудьте 3 дерева"},
    "tutorial_craft": {"title": "Первый крафт", "description": "Вы скрафтили доски",
                       "action": "Скрафтите доски из дерева"},
    "tutorial_builder": {"title": "Строитель", "description": "Вы поставили первые блоки",
                         "action": "Поставьте 5 блоков"},
    "tutorial_workbench": {"title": "Мастерская", "description": "Рядом со столом доступны новые рецепты",
                           "action": "Скрафтите стол и встаньте рядом"},
    "tutorial_supplies": {"title": "Запасливый", "description": "Вы забрали припасы из сундука",
                          "action": "Заберите припасы из сундука"},
    "tutorial_furnace": {"title": "Печник", "description": "Вы построили печку",
                         "action": "Скрафтите и поставьте печку"},
    "tutorial_cauldron": {"title": "Зельевар-подмастерье", "description": "Вы построили котёл",
                          "action": "Скрафтите и поставьте котёл"},
    "tutorial_bucket": {"title": "Водонос", "description": "Вы сделали ведро",
                        "action": "Скрафтите ведро из железа"},
    "tutorial_water": {"title": "Полное ведро", "description": "Вы набрали воды",
                       "action": "Наберите воду ведром из водоёма"},
    "tutorial_potion": {"title": "Первое зелье", "description": "Вы сварили зелье в котле",
                        "action": "Сварите любое зелье в котле"},
    "tutorial_done": {"title": "Первые шаги", "description": "Вы прошли обучение",
                      "action": "Пройдите все шаги обучения"},
}
