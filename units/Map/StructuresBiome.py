...
# Описания: (имя, шанс, схема, биомы)
Structures_biome_middleworld = {
    10020: ("desert marker", 0.20, DESERT_MARKER, (0,)),
    10021: ("desert crypt", 0.08, DESERT_CRYPT, (0,)),
    10022: ("savanna watchpost", 0.12, SAVANNA_WATCHPOST, (1,)),
    10023: ("tundra camp", 0.12, TUNDRA_CAMP, (3,)),
    10024: ("tropical temple", 0.07, TROPICAL_TEMPLE, (2,)),
    10025: ("rainforest greenhouse", 0.10, RAINFOREST_GREENHOUSE, (5,)),
    10026: ("forest observatory", 0.06, FOREST_OBSERVATORY, (4, 6, 7)),
    10027: ("boreal sawmill", 0.12, BOREAL_SAWMILL, (8,)),
    # без привязки к биому, но глубоко: пещерные постройки стоят в камне
    10028: ("deep mine", 0.10, DEEP_MINE, None),
    10029: ("cave shrine", 0.06, CAVE_SHRINE, None),
}
